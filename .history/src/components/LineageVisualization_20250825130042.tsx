...
export const LineageVisualization: React.FC<LineageVisualizationProps> = ({
  ...
  const generateHierarchicalLayout = useCallback((
    ...
    const horizontalSpacing = 350; // Reduced horizontal spacing
    const baseVerticalSpacing = 200; // Base vertical spacing
    const minVerticalGap = 160; // Minimum gap between nodes
    const jitterRange = 40; // Range for random offset
